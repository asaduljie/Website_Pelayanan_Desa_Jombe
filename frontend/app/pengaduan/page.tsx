          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-xs">
            ...
            <div className="space-y-1">
              ...
              <textarea
                ...
                placeholder="Jelaskan secara rinci kondisi lapangan agar petugas dapat menindaklanjuti..."
                className="w-full px-3.5 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-700 bg-gray-50 text-gray-900"
              ></textarea>
            </div>
              ...
              {complaints.map((item) => (
                <div key={item.id} className="bg-white p-6 rounded-3xl border border-slate-200 shadow-soft space-y-3 hover:border-emerald-300 transition-all">
                  ...
                  {item.assignedOfficer && (
                    <div className="text-[11px] font-bold text-emerald-900 bg-emerald-50 px-3 py-1.5 rounded-xl border border-emerald-200/80 flex items-center gap-1.5 w-fit">
                      <CheckCircle2 className="w-3.5 h-3.5 text-emerald-700" /> Ditugaskan ke: <strong>{item.assignedOfficer}</strong>
                    </div>
                  )}
      ...
      {selectedDetailComplaint && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-xl w-full p-6 sm:p-8 space-y-6 shadow-2xl overflow-y-auto max-h-[90vh] border border-slate-200 animate-in zoom-in-95 duration-150 text-xs">
            ...
            {selectedDetailComplaint.assignedOfficer && (
              <div className="p-3.5 bg-emerald-50/80 rounded-2xl border border-emerald-200 flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-700 shrink-0" />
                <span className="text-emerald-950 font-bold">
                  Ditugaskan ke Petugas Lapangan: <strong>{selectedDetailComplaint.assignedOfficer}</strong>
                </span>
              </div>
            )}
            ...
            {selectedDetailComplaint.adminResponse ? (
              <div className="p-4 rounded-2xl bg-emerald-50 border border-emerald-200 space-y-1">
                <span className="font-extrabold text-emerald-900 block flex items-center gap-1.5">
                  <CheckCircle2 className="w-4 h-4 text-emerald-700" /> Tanggapan Resmi Petugas Desa:
                </span>
              ...
              <div className="p-4 rounded-2xl bg-amber-50 border border-amber-200 text-amber-900 flex items-center gap-2">
                ...
                <span>Pengaduan sedang menunggu pemeriksaan dan tindak lanjut dari petugas Desa Jombe.</span>
              </div>
            )}
